...
function HeroMenu() {
  return (
      <div className="   max-w-[1640px] m-auto ">
        <div
          className="  container-hero grid grid-cols-2
            gap-[30px] md:gap-[80px] px-[60px]  py-[30px] pb-[50px] sm:pb-[70px]">
          <div>
            <h1
            ...
            <p className=" text-[14px]  sm:text-[15px]  md:text-[17px]  max-w-[400px]"> 
