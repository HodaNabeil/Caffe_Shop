    ...
    <div className=" container bg-[#fefae0] py-[50px]">
      <h2 
        className="   min-color  element-center 
          pt-[40px] font_3   text-[35px] sm:text-[40px] md:text-[50px]  font-bold
          tracking-[1px]
        "
        >
        Why are we into 
        <span 
          className=" font_3 text-[50px] tracking-[2px] text-[#de9f65]  ml-[7px] block"> 
          sweets
          </span>?
      </h2>
          ...
          <div
            ...
            <div className=" mt-[15px]">
                <h3     className="   min-color  element-center 
                  pt-[15px] font_3 text-[30px] sm-[text-[35px] lg:text-[40px]  font-bold
                  tracking-[1px]
                ">
              Fast delivery</h3>
                <p  className=" font-medium text-[17px] text-[#000000c4] leading-[1.7]">
          ...
          <div className=" bg-[#de9f65]  p-[20px] relative rounded-[8px]
            ...
            <div>
                <h3 className="   min-color  element-center 
                  ...
                  tracking-[1px]
                ">Quality</h3>
                <p className=" font-medium text-[17px] leading-[1.7] text-[#000000c4] "
                >
                  Lorem ipsum dolor sit amet consectetur, adipisicing elit. 
                  Aspernatur doloremque id ex nihil dignissimos sint.
                </p>
