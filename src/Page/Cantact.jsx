    ...
    <div className=" contact  relative   bg-[#fefae0]  ">
        <div className=" relative">
          ...
          <div className="  absolute  top-[50%]  left-[50%] translate-x-[-50%]  translate-y-[-50%]">
            <h2 
              className=" font_3 font-bold text-[40px] sm:text-[60px] md:text-[70px]  tracking-[2px] text-[#fff]">
              Contact Us
            </h2>
          </div>
        </div>
        ...
        <div 
          ...
          className=" container  bg-[#220100]  relative  top-[-80px] sm:top-[-145px] w-[80%]
          flex  justify-between items-center gap-[50px]">

          {
            icons.map((item ,index)=> {
              return <div    key={index}     
              className=" w-[100px] h-[50px]  sm:w-[120px] sm:h-[110px] md:w-[150px] 
