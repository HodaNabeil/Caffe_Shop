...
function LandingDessertPage() {
  return (
      <div className=" landing-sweets  bg-[#220100]  overflow-hidden  ">
        ...
        <Header/>
          <div 
            className=" container   top-[50px] relative  flex    justify-between  gap-x-[30px]">
            <div className="   top-[60px]  relative left-3 w-[48%] text-[#fff] " >
              <h2
                className="font_3  text-[30px] 
                sm:text-[40px]  md:text-[50px] lg:text-[60px]  rotate-[-6deg] ">
                The most delicious and 
                best sweets
              </h2>
              <Link to={'/'} 
                className=" block font_3  relative bg-transparent py-[4px] px-[8px]   text-center
                ...
                left-[50px]  rounded-[50px] text-[#fff]  font-bold
                hover:bg-[#fff] hover:text-[#220100]  hover:tracking-[2px] translate-y-[5px] 
                    transition-all  duration-[0.3s] ">
                menu
              </Link>
            </div>
            <div className=" container-images relative  w-[49%]   flex justify-end  gap-[30px]">
                <img 
                className=" relative object-cover top-[45px]
                w-[180px] h-[200px]  sm:w-[200px] sm:h-[250px] 
                md:w-[250px] md:h-[300px]  lg:w-[300px] lg:h-[385px]  " 
                src={require(`../IMg/dessert-5.jpg`)} alt="img" 
                />
            </div>
          </div>
