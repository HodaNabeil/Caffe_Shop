...
function WhyUs() {
  return (
    <div className="why bg-[#100908fa]  relative w-full pt-[80px] pb-[40px]">
      ...
      <i className=" absolute top-[53px]  text-[20px]  fa-solid fa-mug-hot"></i>
    </div>
    <div className=' container px-[30px] grid sm:grid-cols-1  md:grid-cols-2 lg:grid-cols-3 pt-[40px]  gap-x-7'>
